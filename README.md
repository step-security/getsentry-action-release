...
- name: Create Sentry release
  uses: step-security/getsentry-action-release@v3
  env:
...
[issues page](https://github.com/step-security/getsentry-action-release/issues).
...
- When adding the action, make sure to first check out your repo with `actions/checkout@v7`.
